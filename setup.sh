...
if [[ "$arg" == "-i" || "$arg" == "--install" ]]; then
    ...
    echo -e "  \u001b[34;1m3) for Custom zsh plugins\u001b[0m"
    echo -e "  \u001b[34;1m4) for HomeBrew stuff\u001b[0m"
    ...
    "2")echo -e "\u001b[7mInstalling Powerlevel9K...\u001b[0m"
        ...
        ;;
    "3")echo -e "\u001b[7mInstalling Custom zsh plugins ...\u001b[0m"
     ...
     "4")echo -e "\u001b[7mInstalling HomeBrew stuff ...\u001b[0m"
